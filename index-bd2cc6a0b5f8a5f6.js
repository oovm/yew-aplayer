import { build_aplayer } from './snippets/aplayer-wasmbind-3c7dd9704212333f/src/aplayer.min.js';
...
/**
*/
export class APlayerAudio {

    free() {
        const ptr = this.ptr;
        this.ptr = 0;

        wasm.__wbg_aplayeraudio_free(ptr);
    }
}
/**
*/
export class APlayerOptions {

    free() {
        const ptr = this.ptr;
        this.ptr = 0;

        wasm.__wbg_aplayeroptions_free(ptr);
    }
    /**
    * @returns {boolean}
    */
    get autoplay() {
        var ret = wasm.__wbg_get_aplayeroptions_autoplay(this.ptr);
        return ret !== 0;
    }
    /**
    * @param {boolean} arg0
    */
    set autoplay(arg0) {
        wasm.__wbg_set_aplayeroptions_autoplay(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get volume() {
        var ret = wasm.__wbg_get_aplayeroptions_volume(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set volume(arg0) {
        wasm.__wbg_set_aplayeroptions_volume(this.ptr, arg0);
    }
    /**
    * @returns {boolean}
    */
    get mutex() {
        var ret = wasm.__wbg_get_aplayeroptions_mutex(this.ptr);
        return ret !== 0;
    }
    /**
    * @param {boolean} arg0
    */
    set mutex(arg0) {
        wasm.__wbg_set_aplayeroptions_mutex(this.ptr, arg0);
    }
    /**
    * @returns {boolean}
    */
    get list_folded() {
        var ret = wasm.__wbg_get_aplayeroptions_list_folded(this.ptr);
        return ret !== 0;
    }
    /**
    * @param {boolean} arg0
    */
    set list_folded(arg0) {
        wasm.__wbg_set_aplayeroptions_list_folded(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get list_max_height() {
        var ret = wasm.__wbg_get_aplayeroptions_list_max_height(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set list_max_height(arg0) {
        wasm.__wbg_set_aplayeroptions_list_max_height(this.ptr, arg0);
    }
}
...
async function init(input) {
    ...
    imports.wbg.__wbg_buildaplayer_585846dabc49e9d3 = function(arg0, arg1) {
        build_aplayer(getObject(arg0), getObject(arg1));
    };
